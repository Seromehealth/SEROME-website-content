...
let clientTestimonials = [
    ...
    {
        comment: "Client comment goes here 02",
        name: "Client Name 02",
        location: "Client Location 02"
    },
...
let testimonialComment01 = document.getElementById('testimonialComment01');
testimonialComment01.innerHTML = clientTestimonials[0].comment;
...
let testimonialComment02 = document.getElementById('testimonialComment02');
testimonialComment02.innerHTML = clientTestimonials[1].comment;
...
let testimonialComment03 = document.getElementById('testimonialComment03');
testimonialComment03.innerHTML = clientTestimonials[2].comment;
...
let testimonialComment04 = document.getElementById('testimonialComment04');
testimonialComment04.innerHTML = clientTestimonials[3].comment;
...
let testimonialComment05 = document.getElementById('testimonialComment05');
testimonialComment05.innerHTML = clientTestimonials[4].comment;
